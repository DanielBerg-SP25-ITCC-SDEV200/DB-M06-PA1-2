...
public class Excercise35_01 extends Application {
    ...
    private void showDBConnectionDialog(Stage ownerStage) {
        ...
        TextField jdbcDriverField = new TextField("org.mariadb.jdbc.Driver");
        Label databaseUrlLabel = new Label("Database URL");
        TextField databaseUrlField = new TextField("jdbc:mariadb://localhost/mydb");
